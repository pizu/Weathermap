...
NODE firewall_status
    ...
    <p>SNMP v3 adds a lot of new features over v2c including encryption and real authentication. As
        a result, the confguration for a single OID is quite verbose. To avoid having very long TARGET
        strings, the configuration is different. Instead of a community name, you specify a <em>PROFILE NAME</em>.
        Profiles
        can be defined in two ways: as a set of SET variables, or by copying settings from Cacti.
    </p>
    ...
    <div class="definition">
        SET snmp3_PROFILE1_username myusername
        SET snmp3_PROFILE1_seclevel authPriv
        SET snmp3_PROFILE1_authproto SHA
        SET snmp3_PROFILE1_authpass somepassword
        SET snmp3_PROFILE1_privproto AES
        SET snmp3_PROFILE1_privpass someotherpassword
    </div>
