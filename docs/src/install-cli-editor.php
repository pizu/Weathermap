...
?>
            ...
            <a href = "http://pear.php.net/">PEAR</a> module. A copy of this
            library (version 1.4.3) is bundled in <tt>lib/Console</tt> so you do
            not need to install PEAR separately.</p>
